...
class MangaBannerAdapter(private var mangas : MutableList<Manga>, private var context: Context) : RecyclerView.Adapter<MangaBannerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.list_item_manga_1,parent,false))
    }
